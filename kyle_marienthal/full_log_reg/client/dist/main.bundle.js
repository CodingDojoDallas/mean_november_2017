...
var routes = [
    ...
    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_4__note_note_component__["a" /* NoteComponent */], children: [
            { path: '', component: __WEBPACK_IMPORTED_MODULE_5__note_note_list_note_list_component__["a" /* NoteListComponent */] }
        ] },
    { path: '', pathMatch: 'full', component: __WEBPACK_IMPORTED_MODULE_3__user_user_new_user_new_component__["a" /* UserNewComponent */], children: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__note_note_component__ = __webpack_require__("../../../../../src/app/note/note.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__note_note_list_note_list_component__ = __webpack_require__("../../../../../src/app/note/note-list/note-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__user_user_logout_user_logout_component__ = __webpack_require__("../../../../../src/app/user/user-logout/user-logout.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_10__note_note_list_note_list_component__["a" /* NoteListComponent */],
                __WEBPACK_IMPORTED_MODULE_11__user_user_logout_user_logout_component__["a" /* UserLogoutComponent */]
            ],
            imports: [
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_6__user_user_service__["a" /* UserService */]],
...
var UserNewComponent = (function () {
    function UserNewComponent(_route, _userService //dependency injection: allows us to pull in  adifferent model or library into our class (so whenever we want to use the UserNewComponent we have access to the UserService)
    ) {
        this._route = _route;
        this._userService = _userService; //dependency injection: allows us to pull in  adifferent model or library into our class (so whenever we want to use the UserNewComponent we have access to the UserService)
    }
    ...
    UserNewComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */],
            __WEBPACK_IMPORTED_MODULE_1__user_service__["a" /* UserService */] //dependency injection: allows us to pull in  adifferent model or library into our class (so whenever we want to use the UserNewComponent we have access to the UserService)
        ])
    ], UserNewComponent);
